...
class CreateTwitterLikesTable extends Migration
{
	...
	public function up()
	{
		...
		$columns = Schema::getColumnListing("twitter_likes");

		$func = Schema::hasTable("twitter_likes") ? "table" : "create";
	...
	/**
	 * Collect all columns that are indexed in the twitter_likes table.
	 *
	 * @return array
	 */
	private function collectIndexedColumns(): array
	{
		...
		$tbl = $sm->introspectTable("twitter_likes");
