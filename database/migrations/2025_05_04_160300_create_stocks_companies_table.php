...
class CreateStocksCompaniesTable extends Migration
{
	...
	public function up()
	{
		...
		Schema::$func("stocks_companies", function (Blueprint $table) use ($columns, $indexes) {
			!in_array("company_id", $columns) && $table->integer("company_id")->autoIncrement(); // primary key
			!in_array("owner_cid", $columns) && $table->integer("owner_cid")->nullable();
			!in_array("owner_name", $columns) && $table->string("owner_name", 255)->nullable();
			!in_array("company_name", $columns) && $table->string("company_name", 255)->nullable();
			!in_array("company_description", $columns) && $table->longText("company_description")->nullable();
			!in_array("company_logo", $columns) && $table->string("company_logo", 255)->nullable();
