...
class CreateLeaderboardArenaTable extends Migration
{
	...
	public function up()
	{
		...
		$tableExists = Schema::hasTable("leaderboard_arena");
	...
	{
		$columns = Schema::getConnection()->select("SHOW COLUMNS FROM `leaderboard_arena`");
	...
	{
		$indexes = Schema::getConnection()->select("SHOW INDEXES FROM `leaderboard_arena` WHERE Key_name != 'PRIMARY'");
