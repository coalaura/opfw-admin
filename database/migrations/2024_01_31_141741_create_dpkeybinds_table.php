...
class CreateDpkeybindsTable extends Migration
{
	...
	public function up()
	{
		...
		$columns = Schema::getColumnListing("dpkeybinds");

		$func = Schema::hasTable("dpkeybinds") ? "table" : "create";
	...
	/**
	 * Collect all columns that are indexed in the dpkeybinds table.
	 *
	 * @return array
	 */
	private function collectIndexedColumns(): array
	{
		...
		$tbl = $sm->introspectTable("dpkeybinds");
