...
class CreateIpChecksTable extends Migration
{
	...
	public function up()
	{
		...
		$columns = Schema::getColumnListing("ip_checks");

		$func = Schema::hasTable("ip_checks") ? "table" : "create";
	...
	/**
	 * Collect all columns that are indexed in the ip_checks table.
	 *
	 * @return array
	 */
	private function collectIndexedColumns(): array
	{
		...
		$tbl = $sm->introspectTable("ip_checks");
