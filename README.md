...
*If you question the commit history, I invest my time on rapid development and practical fixes rather than granular documentation since I (Laura) am the sole developer maintaining it, Ido not see additional value in spending more of my time meticulously documenting every tiny change i commit.*
