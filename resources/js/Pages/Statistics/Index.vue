<template>
    <div>
        ...
        <template>
            ...
            <div class="mt-7 bg-gray-100 p-6 rounded shadow-lg max-w-full w-map dark:bg-gray-700">
            ...
            <div class="bg-gray-100 p-6 rounded shadow-lg max-w-full w-map dark:bg-gray-700 text-gray-600 dark:text-gray-400 font-semibold">
                {{ t('statistics.casino_revenue') }}

                <span :class="casinoRevenue > 0 ? 'text-green-500' : 'text-red-500'">{{ numberFormat(casinoRevenue, 0, true) }}</span>
            </div>

            <div class="mt-7 bg-gray-100 p-6 rounded shadow-lg max-w-full w-map dark:bg-gray-700" v-if="blackjack.labels.length > 0">
                ...
                <div class="flex">
                    ...
                    <div class="text-xs mt-3 ml-6" v-if="blackjack.my_place">
            ...
            <div class="mt-7 bg-gray-100 p-6 rounded shadow-lg max-w-full w-map dark:bg-gray-700" v-if="slots.labels.length > 0">
                ...
                <div class="flex">
                    ...
                    <div class="text-xs mt-3 ml-6" v-if="slots.my_place">
                        <span class="text-sm font-semibold mb-1 block">{{ t('statistics.your_spot') }}</span>
                        <span class="flex font-mono">
            ...
            <div class="mt-7 bg-gray-100 p-6 rounded shadow-lg max-w-full w-map dark:bg-gray-700" v-if="tracks.labels.length > 0">
                ...
                <div class="flex">
                    ...
                    <div class="text-xs mt-3 ml-6" v-if="tracks.my_place">
                        <span class="text-sm font-semibold mb-1 block">{{ t('statistics.your_spot') }}</span>
                        <span class="flex font-mono">
