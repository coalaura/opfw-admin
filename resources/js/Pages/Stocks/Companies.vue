            ...
            <template #default>
                ...
                <div class="w-full mt-3">
                    ...
                    <div class="text-sm bg-gray-200 dark:bg-gray-700 flex" v-for="(key, index) in editingProperty.keys" :key="index">
                        ...
                        <input class="px-1 py-0.5 block bg-gray-200 dark:bg-gray-800 text-sm w-32 border-r-0 focus:outline-none" placeholder="John Doe" :value="key.name" readonly disabled />
